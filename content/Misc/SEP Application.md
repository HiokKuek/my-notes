...
- CS3219 Software Engineering Principle (10ECTS)
Link: https://nus.edu.sg/gro/docs/default-source/prog/sep/pu/dk/sep_dk_aarhus.pdf

### Tallinn Uni of Technology (Estonia) (1 Vacancy)
	id: E0000001741
	Min: 15 ECTS
	Max: 30 ECTS
Course Mappings: 
- CS3230 Design and Analysis of Algorithm (6 unit) 
- CS2105 Introduction to software engin (6 unit)
- CS31033 Computer Networks Practice (6 unit)
- CS3226 Web Programming and Applications (6 unit)

Link: https://nus.edu.sg/gro/docs/default-source/prog/sep/pu/ee/sep_estonia_tallinn.pdf

2. Warsaw University of Technology (Poland) (1 Vacancy)

### Uppsala Uni (Sweden) (4 Vacancy)
	id: E0000000569
...
### Connecticut (US) (5 Vacancy)
	12-17units
	id: E0000001421 
	- CS2106 Introduction to Operation Sys (3units)
	- CS3244 Machine Learning
	- CS3243 Introudction to AI
	- CS2105 Introduction to Computer Networks
	
Link: https://nus.edu.sg/gro/docs/default-source/prog/sep/pu/us/sep_usa_university_of_connecticut.pdf

### University of California (US) (20 Vacancy)
- 10 campus, research 3 campuses and rank them from 1 to 3 in order of preference.
- Placement is done by UCEAP and not NUS
- I think should be quite easy to find CS mods, but more research is required! 

Course Mapping: 
- Research from: https://reciprocity.uceap.universityofcalifornia.edu/plan-your-studies/uc-courses

Link: https://nus.edu.sg/gro/docs/default-source/prog/sep/pu/us/sep_usa_university_of_california.pdf


Link: E0000001439 

### Uni N Carolina at Chapel Hill (US) (12 Vacancy)
	id: E0000001382
	12 credits +
